...
def mock_event_publisher():
    """
    Подменяет EventPublisher на AsyncMock.
    Предотвращает попытки подключения к Redis при обновлении аватара.
    """
    with patch("app.repository.image_repository.EventPublisher") as MockPub:
